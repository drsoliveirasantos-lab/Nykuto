(() => {
  ...
  COPY.push(
    ...
    [`Démo immobilière`, `Real-estate demo`, `Demo imobiliária`, `Demo inmobiliaria`],
    [`Démo interactive · immobilier`, `Interactive demo · real estate`, `Demo interativa · imóveis`, `Demo interactiva · inmobiliaria`],
    [`Portail immobilier à Ciudad del Este`, `Real-estate portal in Ciudad del Este`, `Portal imobiliário em Ciudad del Este`, `Portal inmobiliario en Ciudad del Este`],
    [`Transformez des annonces dispersées en catalogue mobile avec filtres, médias, zones approximatives et parcours de contact simulé.`, `Turn scattered listings into a mobile catalogue with filters, media, approximate zones and a simulated contact journey.`, `Transforme anúncios dispersos em um catálogo mobile com filtros, mídia, zonas aproximadas e uma jornada de contato simulada.`, `Convierta anuncios dispersos en un catálogo móvil con filtros, contenido multimedia, zonas aproximadas y un recorrido de contacto simulado.`],
    [`Annonces`, `Listings`, `Anúncios`, `Anuncios`],
    [`Carte`, `Map`, `Mapa`, `Mapa`],
    [`Explorer la démo`, `Explore the demo`, `Explorar a demo`, `Explorar la demo`],
    [`Explorer la démonstration du portail immobilier`, `Explore the real-estate portal demo`, `Explorar a demonstração do portal imobiliário`, `Explorar la demostración del portal inmobiliario`],
    [`Aperçu illustratif du portail immobilier Nykuto`, `Illustrative preview of the Nykuto real-estate portal`, `Prévia ilustrativa do portal imobiliário Nykuto`, `Vista previa ilustrativa del portal inmobiliario Nykuto`],
    [`Démo portail immobilier — Nykuto`, `Real-estate portal demo — Nykuto`, `Demo de portal imobiliário — Nykuto`, `Demo de portal inmobiliario — Nykuto`],
    [`Retour aux scénarios`, `Back to scenarios`, `Voltar aos cenários`, `Volver a los escenarios`],
    [`Démonstration interactive · immobilier`, `Interactive demo · real estate`, `Demonstração interativa · imóveis`, `Demostración interactiva · inmobiliaria`],
    [`Une annonce WhatsApp transformée en expérience de recherche.`, `A WhatsApp listing turned into a search experience.`, `Um anúncio do WhatsApp transformado em experiência de busca.`, `Un anuncio de WhatsApp convertido en una experiencia de búsqueda.`],
    [`Cette vitrine montre comment une agence peut présenter ses biens, protéger leur localisation, filtrer les demandes et guider chaque visiteur vers un contact qualifié.`, `This showcase demonstrates how an agency can present properties, protect their location, filter enquiries and guide each visitor towards a qualified contact.`, `Esta vitrine mostra como uma imobiliária pode apresentar seus imóveis, proteger a localização, filtrar solicitações e conduzir cada visitante a um contato qualificado.`, `Esta muestra enseña cómo una agencia puede presentar sus propiedades, proteger su ubicación, filtrar consultas y guiar a cada visitante hacia un contacto cualificado.`],
    [`Périmètre de la démonstration`, `Demo scope`, `Escopo da demonstração`, `Alcance de la demostración`],
    [`Prototype fonctionnel`, `Functional prototype`, `Protótipo funcional`, `Prototipo funcional`],
    [`Mobile · Liste · Carte · Médias`, `Mobile · List · Map · Media`, `Mobile · Lista · Mapa · Mídia`, `Móvil · Lista · Mapa · Contenido multimedia`],
    [`L’interface client ci-dessous est volontairement présentée en portugais brésilien, langue principale du cas illustré à Ciudad del Este.`, `The customer interface below is intentionally shown in Brazilian Portuguese, the main language for the scenario illustrated in Ciudad del Este.`, `A interface do cliente abaixo é apresentada intencionalmente em português brasileiro, idioma principal do caso ilustrado em Ciudad del Este.`, `La interfaz de cliente que figura a continuación se presenta deliberadamente en portugués de Brasil, idioma principal del caso ilustrado en Ciudad del Este.`],
    [`Concept indépendant`, `Independent concept`, `Conceito independente`, `Concepto independiente`],
    [`Cette démonstration Nykuto n’est pas le site officiel d’une agence. Les photos et vidéos proviennent de logements réels à Ciudad del Este et ont été neutralisées pour cette présentation. Les noms, références, prix, disponibilités, distances, zones et interactions restent illustratifs ; aucun paiement ni réservation n’est proposé ici.`, `This Nykuto demo is not an agency’s official website. The photos and videos come from real homes in Ciudad del Este and have been anonymised for this presentation. Names, references, prices, availability, distances, zones and interactions remain illustrative; no payment or booking is offered here.`, `Esta demonstração da Nykuto não é o site oficial de uma imobiliária. As fotos e os vídeos são de imóveis reais em Ciudad del Este e foram anonimizados para esta apresentação. Nomes, referências, preços, disponibilidade, distâncias, zonas e interações continuam ilustrativos; nenhum pagamento ou reserva é oferecido aqui.`, `Esta demostración de Nykuto no es el sitio web oficial de una agencia. Las fotos y los vídeos proceden de viviendas reales de Ciudad del Este y se han anonimizado para esta presentación. Los nombres, referencias, precios, disponibilidad, distancias, zonas e interacciones siguen siendo ilustrativos; aquí no se ofrecen pagos ni reservas.`],
    [`Votre activité pourrait disposer de sa propre expérience.`, `Your business could have its own experience.`, `Sua atividade poderia ter uma experiência própria.`, `Su actividad podría contar con su propia experiencia.`],
    [`Identité visuelle, contenus, annonces et parcours de contact seraient cadrés avec vos données et vos règles réelles.`, `Visual identity, content, listings and contact journey would be scoped around your real data and rules.`, `Identidade visual, conteúdos, anúncios e jornada de contato seriam definidos com seus dados e regras reais.`, `La identidad visual, el contenido, los anuncios y el recorrido de contacto se definirían con sus datos y normas reales.`],
    [`Demander une démonstration adaptée`, `Request a tailored demo`, `Solicitar uma demonstração personalizada`, `Solicitar una demostración adaptada`],
