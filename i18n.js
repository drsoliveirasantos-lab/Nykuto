(() => {
  ...
  COPY.push(
    ...
    [`Nykuto, le chat orange à l’origine du nom de l’entreprise`, `Nykuto, the orange cat behind the company name`, `Nykuto, o gato laranja que deu origem ao nome da empresa`, `Nykuto, el gato naranja que dio origen al nombre de la empresa`],
    [`Nykuto, à l’origine du nom et de l’emblème.`, `Nykuto, the inspiration behind the name and emblem.`, `Nykuto, a origem do nome e do emblema.`, `Nykuto, el origen del nombre y del emblema.`],
    [`Origine de la marque`, `Brand origin`, `Origem da marca`, `Origen de la marca`],
    [`Avant d’être une entreprise, Nykuto était un chat orange.`, `Before it was a business, Nykuto was an orange cat.`, `Antes de ser uma empresa, Nykuto era um gato laranja.`, `Antes de ser una empresa, Nykuto era un gato naranja.`],
    [`Nykuto était le premier chat de Diego, un compagnon qui a marqué son enfance.`, `Nykuto was Diego’s first cat, a companion who left a lasting mark on his childhood.`, `Nykuto foi o primeiro gato de Diego, um companheiro que marcou sua infância.`, `Nykuto fue el primer gato de Diego, un compañero que marcó su infancia.`],
    [`Son nom est ensuite devenu son pseudonyme dans les jeux vidéo, puis une identité numérique sous laquelle ses proches le reconnaissaient.`, `His name later became Diego’s gaming username, then the digital identity by which those close to him recognised him.`, `Depois, seu nome se tornou o pseudônimo de Diego nos videogames e, mais tarde, a identidade digital pela qual as pessoas próximas o reconheciam.`, `Después, su nombre se convirtió en el seudónimo de Diego en los videojuegos y, más tarde, en la identidad digital por la que lo reconocían sus allegados.`],
    [`Au moment de créer son entreprise, ce nom s’est imposé naturellement. Le chat et les nuances dorées rendent hommage à Nykuto et à son pelage orange. Le bâton au serpent rappelle le parcours médical de Diego ; le livre ouvert, ses études en commerce international.`, `When the business was created, the name was a natural choice. The cat and golden tones honour Nykuto and his orange coat. The serpent staff reflects Diego’s medical journey; the open book, his studies in international business.`, `Quando a empresa foi criada, esse nome surgiu naturalmente. O gato e os tons dourados homenageiam Nykuto e sua pelagem laranja. O bastão com a serpente remete à trajetória de Diego na medicina; o livro aberto, aos seus estudos em comércio internacional.`, `Al crear la empresa, el nombre surgió de forma natural. El gato y los tonos dorados rinden homenaje a Nykuto y a su pelaje naranja. El bastón con la serpiente recuerda la trayectoria médica de Diego; el libro abierto, sus estudios de comercio internacional.`],
    [`Les trois étapes de l’histoire de Nykuto`, `The three stages of the Nykuto story`, `As três etapas da história de Nykuto`, `Las tres etapas de la historia de Nykuto`],
    [`01 · Enfance`, `01 · Childhood`, `01 · Infância`, `01 · Infancia`],
    [`02 · Identité numérique`, `02 · Digital identity`, `02 · Identidade digital`, `02 · Identidad digital`],
    [`03 · Entreprise`, `03 · Business`, `03 · Empresa`, `03 · Empresa`],
    [`Un nom d’enfance devenu une signature professionnelle.`, `A childhood name turned professional signature.`, `Um nome de infância que se tornou uma assinatura profissional.`, `Un nombre de infancia convertido en firma profesional.`],
