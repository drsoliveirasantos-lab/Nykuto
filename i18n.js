(() => {
  ...
  COPY.push(
    ...
    [`Cette démonstration Nykuto n’est pas le site officiel d’une agence. Les médias sont générés et les biens, états, disponibilités, distances et interactions sont illustratifs ; aucun paiement ni réservation n’est proposé ici.`, `This Nykuto demo is not an agency’s official website. Media is generated and properties, statuses, availability, distances and interactions are illustrative; no payment or booking is offered here.`, `Esta demonstração da Nykuto não é o site oficial de uma imobiliária. As mídias são geradas e os imóveis, status, disponibilidade, distâncias e interações são ilustrativos; nenhum pagamento ou reserva é oferecido aqui.`, `Esta demostración de Nykuto no es el sitio web oficial de una agencia. El contenido multimedia es generado y las propiedades, estados, disponibilidades, distancias e interacciones son ilustrativos; aquí no se ofrecen pagos ni reservas.`],
