import { authorizeDataset, serveDataset } from './jeu04.js';
...
export const onRequest = async context => {
  ...
  if (!query.has('dataset') && !query.has('part')) return serveDataset(context, `${HISTORY_PREFIX}/manifest`, 'application/json; charset=utf-8', { ownerVerified: true });
  ...
  return serveDataset(context, `${HISTORY_PREFIX}/${dataset}/part-${part.padStart(3,'0')}`, 'text/plain; charset=utf-8', { ownerVerified: true });
};
