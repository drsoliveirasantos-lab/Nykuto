import { JEU17_PUBLIC as expected } from './jeu17-public.mjs';
import { JEU17_POLICY as policy, JEU17_SCENARIOS as scenarios } from './jeu17-policy.mjs';
import { JEU14_SOURCE as source } from './jeu14-source.mjs';

export async function verifyAblationReport(buffer) {
