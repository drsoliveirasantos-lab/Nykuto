// Game34 derivative of pinned Game33. Monthly reset, funded withdrawal lifecycle.
// Entry rules and sizing stay frozen; the only signal variant removes MYM upstream.
...
export function simulateMonthlyPortfolio(streams, period, costFactor = 1, mode = 'funded') {
  ...
  for (let i = 0; i < ordered[0].candles.length; i++) {
    ...
    for (const s of ordered) {
      ...
      const terms = decision.terms, blocked = accountRiskGate({ balance, floor, dayStart, ...terms }, A, cap);
