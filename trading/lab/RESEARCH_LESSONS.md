...
## Jeu45 — Une sortie peut aider un indice et nuire à un autre

- **L34 — Passer le filtre descriptif ne constitue pas une confirmation indépendante.** MNQ sortie30min est la seule candidate : +91USD normaux et doublés, provenant de deux pertes réduites, avec améliorations mensuelles53,50 enmai/37,50 enjuillet. Aucun autre trade changé, aucune dégradation des16cellules ni du drawdown. Moyenne nette15,76→16,51USD normal /10,49→11,32 doublé. Deux trades déjà vus restent une preuve faible ; référenceJeu40 conservée, aucune activation.
- **L35 — Une meilleure moyenne par trade peut réduire le revenu total.** MES hors Londres améliore la moyenne17,92/10,94USD mais perd167/180,25USD de total, avec juillet normal176→−257,75USD. Les quatre filtres horaires sont rejetés. Le repère Londres porte uniquement sur nos signaux US matinaux et ne mesure pas toutes les séances mondiales.
