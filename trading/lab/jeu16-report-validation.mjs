import { JEU16_PUBLIC as expected } from './jeu16-public.mjs';
import { JEU16_POLICY as policy, JEU16_SCENARIOS as scenarios } from './jeu16-policy.mjs';
import { JEU14_SOURCE as source } from './jeu14-source.mjs';

export async function verifyStructuralReport(buffer) {
