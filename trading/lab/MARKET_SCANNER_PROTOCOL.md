...
La campagne d'axes complémentaire est documentée dans `MARKET_SCANNER_AXES_RESULTS.md`. Son meilleur nouvel ensemble de recherche ajoute failed-breakout + VWAP reclaim/reject + FVG retest au scanner augmenté: 4 903 opportunités, TP1 46.48%, TP2 22.70%, TP3 12.52%. Failed-breakout est le nouvel apport le plus stable; les autres familles restent secondaires/shadow selon le rapport.
