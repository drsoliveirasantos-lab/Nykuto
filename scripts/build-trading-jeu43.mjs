...
const prior=JSON.parse(await readFile('trading/lab/jeu42-freeze.json'));
...
for(const path of ['trading/lab/jeu43-diagnostic.mjs','scripts/run-trading-jeu43.mjs','scripts/build-trading-jeu43.mjs','scripts/test-trading-game43.mjs','trading/lab/jeu43-protocol-table.mjs','trading/lab/JEU43_PROTOCOL.md','trading/lab/JEU43_RESEARCH.md','trading/lab/jeu43-source.json','trading/lab/jeu42-freeze.json'])await visit(path);
const path='trading/lab/jeu43-freeze.json';
if(mode==='freeze')await writeFile(path,JSON.stringify({version:'jeu43-normalized-entry-v1',createdAt:new Date().toISOString(),files},null,2)+'\n',{flag:'wx'});
