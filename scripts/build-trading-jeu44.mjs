...
const prior=JSON.parse(await readFile('trading/lab/jeu43-freeze.json'));
...
for(const path of ['trading/lab/jeu44-diagnostic.mjs','scripts/run-trading-jeu44.mjs','scripts/build-trading-jeu44.mjs','scripts/test-trading-game44.mjs','trading/lab/jeu44-protocol-table.mjs','trading/lab/JEU44_PROTOCOL.md','trading/lab/JEU44_RESEARCH.md','trading/lab/jeu44-video-sources.json','trading/lab/jeu44-source.json','trading/lab/jeu43-freeze.json'])await visit(path);
const path='trading/lab/jeu44-freeze.json';
if(mode==='freeze')await writeFile(path,JSON.stringify({version:'jeu44-video-context-v1',createdAt:new Date().toISOString(),files},null,2)+'\n',{flag:'wx'});
